...
public:
	...
	{
		typedef void(__thiscall* nigga)(void* ecx, float val);
		{
			return v_funk::call_func<nigga>(this, 4)(this, val);
		}
	}
	void set_vector_value(Vector value)
	{
		typedef void(__thiscall* nigga)(void* ecx, float x, float y, float z);
		{
			return v_funk::call_func<nigga>(this, 11)(this, value.x, value.y, value.z);
		}
	}	
};
class IVModelRender
