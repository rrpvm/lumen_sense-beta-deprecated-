...
public:
    ...
    bool ShouldHitEntity(IHandleEntity* pEntityHandle, int /*contentsMask*/)
    {
        IClientEntity* buffer = reinterpret_cast<IClientEntity*>(pEntityHandle);
        ClientClass* cl = buffer->GetClientClass();
        return pEntityHandle != pEnt && cl->m_ClassID == 40;
    }
    virtual TraceType GetTraceType() const
    {
        return TraceType::TRACE_ENTITIES_ONLY;
