...
class ClientClass;
//#include "VFunc.h"
typedef void(__thiscall* ClientCmdUnres)(void* ecx, const char* txt);
...
public:
	...
	{
		typedef float(__thiscall* o_latency)(void* ecx, int flow);
		return v_funk::call_func<o_latency>(this, 9)(this, flow);
	}	
	char pad_0000[20];
...
public:
	...
	virtual  NetworkChannel* GetNetChannelInfo(void) = 0;
	virtual void                  DebugDrawPhysCollide(const void* pCollide, IMaterial* pMaterial, const matrix3x4_t& transform, const uint8_t* color) = 0; //79
...
//	void                ExecuteClientCmd(const char* szCmdString) = 0; //108
};